...
{
    /*
     * If you are asking yourself why not just inherit stuff
     * it results in local queries execution in EF o_O */
    public class EmployeeQueryModel : IQueryModel
    {
        ...
        [AllowSort]
        [AllowSearch]
        [DisplayInfo("Company", Group = "Employment Info")]
        public string CompanyName { get; set; }

        [AllowSort]
        [AllowSearch]
        [DisplayInfo("Location", Group = "Employment Info")]
